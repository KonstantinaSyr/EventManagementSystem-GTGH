...
public class OrganizerController {
	...
	OrganizerService organizerService;
	 ...
	 @PostMapping("/update")
	 public List<Organizer> updateOrganizer(@RequestParam int id, @RequestParam(required=false) String name, @RequestParam(required=false)String surname, @RequestParam(required=false)String email, @RequestParam(required=false)Integer afm,
